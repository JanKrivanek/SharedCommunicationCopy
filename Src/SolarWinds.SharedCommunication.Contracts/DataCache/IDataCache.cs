...
namespace SolarWinds.SharedCommunication.Contracts.DataCache
{
    ...
    {
        /// <summary>
        /// Request the data slot from the cache. If cache has existing data with acceptable age (given by Ttl) it will be returned and asyncDataFactory won't be called.
        ...
        /// <summary>
        /// Force set the give data into cache slot. If there is any pre-existing data, it will be erased first. Based for data to be pushed and cancellation token.
        /// </summary>
